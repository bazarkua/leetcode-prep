# 329. Longest Increasing Path in a Matrix — Tips & Approach Log
...
| | |
|---|---|
| **LeetCode** | [leetcode.com/problems/longest-increasing-path-in-a-matrix](https://leetcode.com/problems/longest-increasing-path-in-a-matrix/) |
