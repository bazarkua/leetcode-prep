# 981. Time Based Key-Value Store — Tips & Approach Log
...
| | |
|---|---|
| **LeetCode** | [leetcode.com/problems/time-based-key-value-store](https://leetcode.com/problems/time-based-key-value-store/) |
