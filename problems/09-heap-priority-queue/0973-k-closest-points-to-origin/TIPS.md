# 973. K Closest Points to Origin — Tips & Approach Log
...
| | |
|---|---|
| **LeetCode** | [leetcode.com/problems/k-closest-points-to-origin](https://leetcode.com/problems/k-closest-points-to-origin/) |
