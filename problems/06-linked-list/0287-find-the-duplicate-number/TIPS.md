# 287. Find the Duplicate Number — Tips & Approach Log
...
| | |
|---|---|
| **LeetCode** | [leetcode.com/problems/find-the-duplicate-number](https://leetcode.com/problems/find-the-duplicate-number/) |
