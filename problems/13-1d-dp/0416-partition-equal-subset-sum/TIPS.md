# 416. Partition Equal Subset Sum — Tips & Approach Log
...
| | |
|---|---|
| **LeetCode** | [leetcode.com/problems/partition-equal-subset-sum](https://leetcode.com/problems/partition-equal-subset-sum/) |
