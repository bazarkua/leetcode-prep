# 1584. Min Cost to Connect All Points — Tips & Approach Log
...
| | |
|---|---|
| **LeetCode** | [leetcode.com/problems/min-cost-to-connect-all-points](https://leetcode.com/problems/min-cost-to-connect-all-points/) |
