# 105. Construct Binary Tree from Preorder and Inorder Traversal — Tips & Approach Log
...
| | |
|---|---|
| **LeetCode** | [leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) |
| **Status** | Not started · Attempting · Solved |
...
**Почему (По-русски):** _..._

---

## Syntax snippets (only when I ask)

_Small language bits I asked about (a data-structure call, a loop idiom). Not full solutions._

```python
# example syntax goes here when requested
```
